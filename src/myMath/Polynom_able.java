 ...
 * where: a_1, a_2 ... a_n are real numbers and b_1 less than b_2..  less than b_n less than and=0 are none negative integers (naturals)
 * For formal definitions see: https://en.wikipedia.org/wiki/Polynomial
 * 
 * Such polyg4on has the following functionality:
 * 1. Init:
 * 1.1 Init(String)
 ...
 * 3.5 double root(double x0, double x1, double eps) // assuming (f(x0)*f(x1) less than and=0,
 *  returns f(x2) such that:
 *	//	(i) x0 less than and=x2  less than and=x2 and (ii) {f(x2) less than eps
...
public interface Polynom_able extends cont_function{
	 ...
	 * @param p1 represents the polynom that we want to add to the current polynom.
	 */
	public void add(Polynom_able p1);
	/**
	 * Add m1 to this Polynom
	 * @param m1 represents the monom that we want to add to the current polynom.
	 */
	public void add(Monom m1);
	/**
	 * Subtract p1 from this Polynom
	 * @param p1 represents the monom that we want to substract to the current polynom.
	 */
	public void substract(Polynom_able p1);
	/**
	 * Multiply this Polynom by p1
	 * @param p1 represents the monom that we want to multiply to the current polynom.
	 */
	public void multiply(Polynom_able p1);
	/**
	 * Test if this Polynom is logically equals to p1.
	 * @param p1 represents the polynom that we want to compare with the current polynom.
	 * @return true iff this pulynom represents the same function ans p1
	 */
	public boolean equals (Polynom_able p1);
	/**
	 * Test if this is the Zero Polynom
	 * @return true if that is the zero polynom. else return false
	 */
	public boolean isZero();
	/**
	 * Compute a value x' (x0 less than and=x'less than and=x1) for with |f(x')| less than eps
	 * assuming (f(x0)*f(x1)less than and==0, returns f(x2) such that:
	 * 	(i) x0 less than and=x2 less than and=x2 and (ii) f(x2)less than eps
